...
if [[ $1 == "all" ]]; then
    ...
    docker compose -f $COMPOSE_FILE up -d rosbot ros-master
fi

sleep 3

echo -e "${GREEN}done. Type ${BOLD}rostopic list${NC}${GREEN} to see available ROS topics ${NC}"
